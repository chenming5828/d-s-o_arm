...
#define MAVLINK_MSG_ID_RAW_PRESSURE_TUPLE 0, MAVLINK_MSG_ID_RAW_PRESSURE
#else
#define MAVLINK_MSG_ID_RAW_PRESSURE_TUPLE MAVLINK_MSG_ID_RAW_PRESSURE
#endif
...
static inline void mavlink_msg_raw_pressure_send(mavlink_channel_t chan, uint64_t time_usec, int16_t press_abs, int16_t press_diff1, int16_t press_diff2, int16_t temperature)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_PRESSURE_TUPLE, (const char *)&packet, MAVLINK_MSG_ID_RAW_PRESSURE_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
#endif
}
...
static inline void mavlink_msg_raw_pressure_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, int16_t press_abs, int16_t press_diff1, int16_t press_diff2, int16_t temperature)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_RAW_PRESSURE_TUPLE, buf, MAVLINK_MSG_ID_RAW_PRESSURE_LEN, MAVLINK_MSG_ID_RAW_PRESSURE_CRC);
#else
